...
class TestNaiveSwitcher(TestCase):
    ...
    def setUp(self):
        ...
        self.equihash = next(
            a for a in self.miner.algorithms if a.algorithms == ["equihash"]
        )
        self.neoscrypt = next(
            a for a in self.miner.algorithms if a.algorithms == ["neoscrypt"]
        )
    ...
    def test_most_profitable(self):
        ...
        revenues = {
            device: {self.equihash: equihash_revenue, self.neoscrypt: neoscrypt_revenue}
        }
    ...
    def test_below_threshold(self):
        ...
        self.switcher.decide({device: {self.equihash: 2.0, self.neoscrypt: 1.0}}, None)
        decision = self.switcher.decide(
            {device: {self.equihash: 2.0, self.neoscrypt: 2.5}}, None
        )
    ...
    def test_above_threshold(self):
        ...
        self.switcher.decide({device: {self.equihash: 2.0, self.neoscrypt: 1.0}}, None)
        decision = self.switcher.decide(
            {device: {self.equihash: 2.0, self.neoscrypt: 3.5}}, None
        )
