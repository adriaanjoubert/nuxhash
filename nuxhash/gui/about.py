...
WEBSITE = "https://github.com/adriaanjoubert/nuxhash"
...
class AboutScreen(wx.Panel):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        h_sizer.Add(v_sizer, wx.SizerFlags().Proportion(1.0).Align(wx.ALIGN_CENTER))

        with open(LOGO_PATH, "rb") as f:
            logo = wx.Image(f, type=wx.BITMAP_TYPE_PNG)
        v_sizer.Add(
            wx.StaticBitmap(self, bitmap=wx.Bitmap(logo)),
        ...
        v_sizer.Add(
            wx.StaticText(
                self, label="A NiceHash client for Linux.", style=wx.ALIGN_CENTER
            ),
