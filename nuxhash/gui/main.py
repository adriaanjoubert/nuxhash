...
class MainWindow(wx.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        notebook.AddPage(MiningScreen(notebook, devices=self._Devices), text="Mining")
        notebook.AddPage(
            BenchmarksScreen(notebook, devices=self._Devices), text="Benchmarks"
        )
        notebook.AddPage(SettingsScreen(notebook), text="Settings")
        notebook.AddPage(AboutScreen(notebook), text="About")
    ...
    def _DownloadMiners(self):
        to_download = [item for item in make_miners(CONFIG_DIR) if not item.verify()]
